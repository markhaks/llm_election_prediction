...
- keeps retweet-related metadata
...
- tweet_text: tweet text for LLM classification
- tweet_date: tweet creation date for time-based analysis
- tweet_lang: language filter, mainly English tweets
- tweet_like_count, tweet_retweet_count, tweet_reply_count, tweet_quote_count: optional engagement signals
- tweet_hashtags: optional political/context signal
- tweet_is_retweet: indicates whether the tweet is a retweet
- tweet_retweeted_tweet_id: original retweeted tweet ID, if available
- tweet_retweeted_user_id: original retweeted user ID, if available
    ...
    try:
        ...
        reduced_df = reduced_df.rename(
            columns={
                ...
                "date": "tweet_date",
                "lang": "tweet_lang",
                "likeCount": "tweet_like_count",
                "retweetCount": "tweet_retweet_count",
                "replyCount": "tweet_reply_count",
                "quoteCount": "tweet_quote_count",
                "hashtags": "tweet_hashtags",
                "retweetedTweet": "tweet_is_retweet",
                "retweetedTweetID": "tweet_retweeted_tweet_id",
                "retweetedUserID": "tweet_retweeted_user_id",
            }
        )
        ...
        column_order = [
            ...
            "tweet_hashtags",
            "tweet_is_retweet",
            "tweet_retweeted_tweet_id",
            "tweet_retweeted_user_id",
            "user_id",
            "user_username",
            "user_location",
            "user_created",
        ...
        reduced_df = reduced_df[column_order]
