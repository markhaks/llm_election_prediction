...
INPUT_DIR = Path(
    r"C:\Users\Mark\Documents\Uni\Bachelorarbeit\llm_election_prediction\data\processed\05_sampling\05_5 Final samples\sampe2"
)

INPUT_FILE = INPUT_DIR / "user_sample_400_users_per_state_tweets.csv"

MODEL = "gpt-5.4-mini"
MODEL_NAME_FOR_COLUMNS = MODEL.replace("-", "_").replace(".", "_")

OUTPUT_FILE = INPUT_DIR / f"user_sample_400_users_per_state_llm_classified_{MODEL_NAME_FOR_COLUMNS}.csv"
CHECKPOINT_FILE = INPUT_DIR / f"user_sample_400_users_per_state_llm_checkpoint_{MODEL_NAME_FOR_COLUMNS}.csv"
