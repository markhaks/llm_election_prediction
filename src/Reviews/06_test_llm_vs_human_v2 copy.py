...
MODEL = "gpt-4o-mini"  # Hinweis: Setze hier dein exaktes Modell ein (z. B. gpt-4o oder gpt-4o-mini)
MODEL_NAME_FOR_COLUMNS = MODEL.replace("-", "_").replace(".", "_")

OUTPUT_FILE = INPUT_DIR / "manuel_labeling_500_tweets_llm_classified_v6.xlsx"
